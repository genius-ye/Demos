...
//            "201.92 109 201.92 174 201.92 185 203.92 193 206.92 199 213.92 205 226.92 207\"]";
     ...
     * 画布的实际宽
     */
    private float canvas_w = 1024;
    /**
     * 画布的实际高
     */
    private float canvas_h = 1024;
    /**
     * 是否可以描红
     */
    ...
    public DrawPinyinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrawPinyinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        initData(pinyinData,pinyinStroke,false);
     ...
     * @param isFill       :是否是填充
     */
    public void initData(String pinyinData, String pinyinStroke, final boolean isFill, final boolean isPlay) {
...
//        canvas.drawColor(Color.WHITE);
    ...
    private void drawPinyinStroke(Canvas canvas) {
        drawStrokePaint.setStyle(Paint.Style.FILL);
        drawStrokePaint.setColor(Color.parseColor("#999999"));
...
//                Log.d("genius", "滑动的距离：" + drawDistance);
    ...
    public void setScaleTimes_x(final float scaleTimes_x) {
        this.scaleTimes_x = scaleTimes_x;
    }

    public void setScaleTimes_y(final float scaleTimes_y) {
        this.scaleTimes_y = scaleTimes_y;
    }
